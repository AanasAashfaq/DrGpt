...
function NavBar() {
  ...
  return (
    <div>
      <nav className="w-full bg-[rgb(40,85,156)] fixed top-0 left-0 right-0 z-10">
        <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
          <div>
            <div className="flex items-center justify-between py-3 md:py-5 md:block">
              {/* LOGO */}
              <img src="/images/DRGPTLOGO.jpg" className='w-[30%]' />
          ...
          <div>
            <div
              className={`flex-1 justify-self-center  mt-8 w-max md:block md:pb-0 md:mt-0 ${
